<section class="section-display">
    <div class="grid grid-rows-2 grid-flow-col">
        <img src="{{ asset('img/infinix-gt-20-pro.png') }}" alt="infinix-gt-20-pro" class="max-w-full object-contain max-xl:hidden">
        <img src="{{ asset('img/Lenovo-LOQ-1.png')}}" alt="ipad_pro_2021" class="max-w-full object-contain max-xl:hidden">
        <div class="flex flex-col row-span-2 self-center max-xl:p-20">
        ...
        <img src="{{ asset('img/apple_ipad_pro_2021_12.9-inci.png') }}" alt="laptop_lenovo_loq" class="max-w-full object-contain max-xl:hidden">
        <img src="{{ asset('img/apple_macbook_air_13_inci_m3_2024.png') }}" alt="apple_macbook_air_13_m3_2024" class="max-w-full object-contain max-xl:hidden">
    </div>
</section>